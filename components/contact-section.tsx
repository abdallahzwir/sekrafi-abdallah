...
import { Mail, Phone, MapPin, Send, Clock, Globe, MessageCircle, Calendar, CheckCircle } from "lucide-react"
        ...
        <div className={`space-y-12 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Ready to bring your ideas to life? I'm here to help you build exceptional digital solutions that drive
              results. Let's discuss your project and explore how we can collaborate.
            </p>
          </div>
            ...
            <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    {contactInfo.map((info, index) => (
                      <div key={index} className="group">
                        ...
                        >
                          <div className="text-secondary mt-0.5 group-hover:scale-110 transition-transform">
                            {info.icon}
                          </div>
              ...
              <Card className="bg-secondary/10 border-secondary/20 hover:shadow-lg transition-shadow">
                <CardContent className="p-6 text-center">
                  ...
                  <h3 className="font-bold text-secondary mb-2">Available for New Projects</h3>
            ...
            <Card className="bg-gradient-to-r from-secondary/10 to-accent/10 border-secondary/20">
              <CardContent className="p-8">
                ...
                <p className="text-muted-foreground mb-6 max-w-2xl mx-auto">
                  Whether you need a complete web application, business analysis, or technical consulting, I'm here to
                  help you achieve your goals with cutting-edge solutions.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Button
                    ...
                    onClick={() => window.open("mailto:abdallah.sek@gmail.com", "_blank")}
                  >
